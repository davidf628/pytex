...
%python
% # this is a comment where an error might happen
% l = []
% l.append(rand(0, 100, prec=10))
%text='$\\frac{2}{3}$'
%end
...
@setlibraryfolder('/Users/flennerdr/Library/CloudStorage/OneDrive-CollegeofCharleston/Courses/MATH 104/exams/question-bank')@

@importpytex('counting-outfit-1.tex')@
