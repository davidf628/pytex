...
\newquestion 
1. (6 pts) Suppose $X$ is a continuous random variable. If $P(X < @a1@) = @c1@$ 
and $P(X < @b1@) = @d1@$, then:\\[4mm]
\begin{enumerate}[a.]
    \item $P(X > @a1@) =$ \iskey{$1 - @c1@ = @sol_1a@$} \\[4mm]
    \item $P(X > @b1@) =$
    \item $P(@a1@ < X < @b1@) =$
\end{enumerate}
...
a1 = rand(2, 8)
b1 = rand(10, 20)
c1 = rrand(0.20, 0.40, 0.01)
d1 = rrand(0.60, 0.80, 0.01)
sol_1a = round(1 - c1, 2)