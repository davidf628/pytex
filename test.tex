...
\newquestion
%variables
%x=rrands(10.0, 25.0, 0.1, 12)
%end
1. (8 pts) You are given the following data representing a random sample
of the amount of coffee a particular person drinks (in ounces) per day.
Based on the sample data, create a 90\% confidence interval for the
population mean. Round your answers to one decimal place. \\[4mm]

\hspace*{1cm}
@showdataarray(x, 5)@
\vspace{8mm}

\hfill \rule{6cm}{0.15mm} \\[2mm]
...
%{
%  a = rand(1, 5)   
%  b = rand(0, 10) where a > b
%} where a - b == 2
%print(f'a == {a}, b == {b}, b - a == {b - a}')
%c = .67 #rrand(0.20, 0.40, 0.01)
